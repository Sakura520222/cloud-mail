const zh = {
    ...
    noFolder: '未分类',
    setFolder: '设置文件夹',
    batchMoveFolder: '批量移动',
    batchAddTag: '批量打标',
    batchRemoveTag: '批量取消标签',
    batchMoveSuccess: '批量移动完成',
    batchTagSuccess: '批量打标完成',
    batchRemoveTagSuccess: '批量取消标签完成',
    aiClassify: 'AI 分类',
    aiTagEmail: 'AI 打标',
    aiAutoClassify: 'AI 自动分类',
    aiAutoTag: 'AI 自动标签',
    aiClassifyDesc: '自动将收到的邮件分类到对应文件夹',
    aiAutoTagDesc: '自动为收到的邮件添加标签',
    aiClassifySuccess: 'AI 分类完成',
    aiTagSuccess: 'AI 打标完成',
    aiClassifying: 'AI 正在分类...',
    aiTagging: 'AI 正在打标...',
    ...
    tagDeleted: '标签已删除',
    confirmDeleteFolder: '确认删除文件夹"{name}"吗？该文件夹下的邮件将变为未分类。',
    confirmDeleteTag: '确认删除标签"{name}"吗？邮件上的标签关联将被移除。',
