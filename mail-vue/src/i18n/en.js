const en = {
    ...
    batchMoveFolder: 'Batch Move',
    batchAddTag: 'Batch Tag',
    batchRemoveTag: 'Batch Untag',
    batchMoveSuccess: 'Batch move completed',
    batchTagSuccess: 'Batch tagging completed',
    batchRemoveTagSuccess: 'Batch untag completed',
    aiClassify: 'AI Classify',
    aiTagEmail: 'AI Tag',
    aiAutoClassify: 'Auto Classify',
    aiAutoTag: 'Auto Tag',
    aiClassifyDesc: 'Automatically classify incoming emails into folders',
    aiAutoTagDesc: 'Automatically tag incoming emails',
    aiClassifySuccess: 'AI classification completed',
    aiTagSuccess: 'AI tagging completed',
    aiClassifying: 'AI is classifying...',
    aiTagging: 'AI is tagging...',
    ...
    confirmDeleteFolder: 'Delete folder "{name}"? Emails in this folder will become uncategorized.',
    confirmDeleteTag: 'Delete tag "{name}"? Tag associations will be removed from emails.',
